  ...
  head: () => ({
    meta: [
      ...
      { title: "ChatHSM — Premium AI workspace" },
      {
        name: "description",
        content:
          "ChatHSM is a premium AI chat workspace with a refined glassmorphism interface and smooth animations.",
      },
      { name: "author", content: "ChatHSM" },
      { property: "og:title", content: "ChatHSM — Premium AI workspace" },
      {
        property: "og:description",
        content: "Premium AI chat workspace with glassmorphism and smooth animations.",
      },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/brand/chathsm-icon-1024-solid.png" },
